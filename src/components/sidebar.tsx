  ...
  return (
    <aside className="glass-rail sticky top-0 flex h-screen w-16 shrink-0 flex-col lg:w-60">
      <div className="flex h-16 items-center gap-3 border-b border-line px-3 lg:px-5">
        {/* Black tile, red letter, red ring. The name beside it is the only
            thing on any screen lit up as a matter of course rather than
            because a figure needs looking at. */}
        <span className="grid h-9 w-9 shrink-0 place-items-center rounded-lg border border-accent/50 bg-black text-base font-bold text-accent shadow-[0_0_18px_-4px_rgba(255,51,85,0.55)]">
          D
        </span>
